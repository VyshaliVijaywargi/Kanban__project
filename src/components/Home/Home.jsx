...
//           {it.content} <span onClick={()=>handleCloseList(item.id,it.id)}><span className={styles.cutIcon}><button className={styles.cutIconBtn}><CloseIcon/></button></span></span>
//         </li>
...
//       <button type="submit" className={styles.btnCard} onClick={()=>handleFormSubmit(item.id)}>Add Card</button>
//       </div>
    ...
    <div className={styles.main}>
      ...
      <ul>
      {
        ...
        <li className={styles.todolist} draggable>
          ...
          <span onClick={()=>handleCloseList(item.id,it.id)} className={styles.cutIcon}><CloseIcon/></span>
        </li>
        <Dialog
